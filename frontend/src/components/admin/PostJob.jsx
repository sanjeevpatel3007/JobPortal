                        ...
                        <div>
                            ...
                            <Input
                              ...
                              placeholder="Software Engineer"
                                ...
                                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1 dark:bg-transparent"
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={changeEventHandler}
                                className="focus-visible:ring-offset-0 dark:bg-transparent focus-visible:ring-0 my-1"
                            />
                        </div>
                        <div>
